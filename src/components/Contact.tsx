    ...
    <Section>
      <div className="border border-border bg-surface backdrop-blur-xl rounded-lg p-8 sm:p-12 text-center">
        ...
        <div className="max-w-md mx-auto">
          ...
          <p className="text-text font-mono text-sm mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <a
                ...
                className="group inline-flex items-center gap-2 px-5 py-3 border border-border hover:border-primary/40 rounded-lg text-muted hover:text-primary font-mono text-xs tracking-wider uppercase transition-all"
              >
                {item.icon && <item.icon size={16} className="group-hover:translate-y-[-1px] transition-transform" />}
                {item.label}
              </a>
            ))}
          </div>
